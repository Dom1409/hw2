...
<head>
    ...
    <link href="<?php echo e(url('css\mhmw1.css')); ?>" rel="stylesheet" type="text/css" media="all"/>
    <script src='<?php echo e(url("js/top_5.js")); ?>' defer="true"></script>
...
<nav class="na">
           <div id="flex_container">
                <button id="home_btn" class="flex_items" href="<?php echo e(url('home')); ?>"><b>Home</b></button>
...
<header class="head"> 
    ...
    <div id="flex_head">
    <div id="img_profile"> <img src="css/image/icona.png" alt="mia icona"> </div>
    </div>
</header>
</div>
...
<div id="box2">
    <div id="box_contenuto2">
       ...
       <p class="paragrafi">Un gioco sparatutto sviluppato da Raven Software e Infinity Ward.
...
<div id="box3">
    <div id="box_contenuto3">
       ...
       <p class="paragrafi">Anch'esso un gioco sparatutto ma sviluppato dalla Riot Games.
                            ...
                            con le abilità che più ti piacciono. Veramente un bel gioco.</p>
                            <br>
...
<div id="box4">
    <div id="box_contenuto4">
       ...
       <p class="paragrafi">Un gioco sparatutto sviluppato dalla Epic Games. Alla sua uscita è stata una novità per tutti
                             ...
                             buona grafica, e con una sua particolarità, ovvero avere la possibilità di difendersi
                              con delle costruzioni posizionate da te durante i combattimenti con i nemici.</p>
...
<div id="box5">
    <div id="box_contenuto5">
       ...
       <p class="paragrafi">Un gioco sviluppato da Psyonix. Un gioco abbastanza diverso da quelli che abbiamo appena visto.
...
<footer id="foot">
     <p id="p_footer"> Domenico Sultano, 1000001926</p></footer>

</body>

</html><?php /**PATH C:\Xampp_new\htdocs\hw2\resources\views/top_5_g.blade.php ENDPATH**/ ?>